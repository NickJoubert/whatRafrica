...
data.frame(allinfo)%>%
  ...
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab('GDP.perCapita')+ylab("betweenness")

data.frame(allinfo)%>%
  ggplot(aes(x=GDP.perCapita,y=degree, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+xlab('GDP.perCapita')+ylab("degree")
...
data.frame(allinfo)%>%
  ...
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("African.rank")+ylab("degree")
...
```
```{r}
more_info<-data.frame(mortality_stats,allinfo)
more_info

```
```{r}
data.frame(more_info)%>%
  ggplot(aes(x=LifeExp,y=closeness, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("LifeExp")+ylab("closeness")

data.frame(more_info)%>%
  ggplot(aes(x=LifeExp,y=betweenness, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("LifeExp")+ylab("betweenness")

data.frame(more_info)%>%
  ggplot(aes(x=LifeExp,y=degree, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("LifeExp")+ylab("degree")

```
```{r}
data.frame(more_info)%>%
  ggplot(aes(x=Neonatel,y=closeness, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("GDP.growth.rate")+ylab("closeness")

data.frame(more_info)%>%
  ggplot(aes(x=Neonatel,y=betweenness, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("GDP.growth.rate")+ylab("betweenness")

data.frame(more_info)%>%
  ggplot(aes(x=Neonatel,y=degree, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+scale_x_log10()+scale_y_log10()+xlab("GDP.growth.rate")+ylab("degree")
```
