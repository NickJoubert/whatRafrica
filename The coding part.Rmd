...
data.frame(info)%>%
  ...
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+ylab("Closeness Centrality")+xlab("betweenness")
...
data.frame(allinfo)%>%
  ...
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+xlab("African.rank")+ylab("betweenness")

data.frame(allinfo)%>%
  ggplot(aes(x=GDP.perCapita,y=closeness, label=name))+
  geom_point()+geom_text()+geom_smooth(method="lm",size = 0.5)+xlab('GDP.perCapita')+ylab("closeness")
